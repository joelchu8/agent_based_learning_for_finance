...
from ..messages.marketdata import MarketDataSubReqMsg, MarketDataMsg, L2DataMsg, TransactedVolDataMsg
...
class TradingAgent(FinancialAgent):
    ...
    def handle_market_data(self, message: MarketDataMsg) -> None:
        ...
        if isinstance(message, L2DataMsg):
            ...
            symbol = message.symbol
            self.transacted_volume[symbol] = (message.bid_volume, message.ask_volume)
